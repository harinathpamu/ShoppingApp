export const ON_CHANGE_FILTER = "FILTER_CHANGED";
export const ON_ADD_TO_CART = "ON_ADD_TO_CART";
export const ON_REMOVE_FROM_CART = "ON_REMOVE_FROM_CART";
export const ON_ADD_QUANTITY = "ON_ADD_QUANTITY";
export const ON_REMOVE_QUANTITY = "ON_REMOVE_QUANTITY";
